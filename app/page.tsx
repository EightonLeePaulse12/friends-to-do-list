    ...
    <>
      <div className="h-screen flex justify-center items-center flex-col">
        <div className="add-btn w-full h-12 flex justify-center items-center p-2">
          <Link href="/add">
            <button type="button" className="flex border-transparent rounded p-1.5 font-bold hover:underline">Add Item <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <tbody>
              {todos.map((todo) => (
                <tr key={todo.id}>
                  ...
                  <td className="p-3" id="test">{todo.isCompleted ? (
                    <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-6">
                      <path d="M12.5 1.31432L3.92857 12.5L0 7.37323L1.00714 6.05891L3.92857 9.86204L11.4929 0L12.5 1.31432Z" fill="#4ECB71" />
                    </svg>

                  ) : (
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-6">
